...
highlights:
  - header: 技术栈
    ...
    highlights:
      - title: JAVA相关技术栈，主要是设计模式，jvm，数据库，以及常用的中间件
        link:  /zh/demo/
        
      - title: 运维相关技术栈，主要是服务器知识，k8s，容器化等技术
      - title: 前端相关技术栈，vue，react+ts等
      - title: 大数据相关技术栈，数仓，flink，spark 等实时及离线计算功能
  ...
  - header: 布局
    ...
    image: /zh/assets/image/layout.svg
  ...
  - header: 新功能
    image: /zh/assets/image/features.svg
  ...
  - header: 博客
    ...
    image: /zh/assets/image/blog.svg
    bgImage: https://theme-hope-assets.vuejs.press/bg/5-light.svg
    bgImageDark: https://theme-hope-assets.vuejs.press/bg/5-dark.svg
    highlights:
      - title: 博客功能
  ...
  - header: 高级
    ...
    image: /zh/assets/image/advanced.svg
...
copyright: false
footer: 使用 <a href="https://theme-hope.vuejs.press/zh/" target="_blank">VuePress Theme Hope</a> 主题 | MIT 协议, 版权所有 © 2019-present WQ
---
